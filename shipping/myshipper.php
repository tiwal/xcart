 ...
 * @version    $Id: myshipper.php,v 1.63.2.5 2012/03/27 11:18:45 aim Exp $
...
function func_shipper ($items, $userinfo, $orig_address, $debug="N", $cart=false)
{
    ...
    if ($ups_rates_only) {
        ...
        && $current_carrier != 'UPS'
        && (!defined('ALL_CARRIERS') || !empty($alt_ship_mods)) // To avoid double run func_shipper_USPS function
    ) {
        $tmp_rates = $intershipper_rates;
        $intershipper_rates = array();
        $alt_ship_mods[] = 'UPS';
