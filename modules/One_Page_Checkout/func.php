 ...
 * @version    $Id: func.php,v 1.23.2.18 2012/03/27 11:18:34 aim Exp $
...
function func_ajax_block_opc_profile()
{
    ...
    $check_smarty_vars = array('XCARTSESSID', 'XCARTSESSNAME', 'anonymous', 'display_antibot', 'reg_antibot_err', 'reg_error', 'show_antibot', 'ship2diff', 'address_fields', 'hide_header', 'login_field_name', 'membership_levels', 'show_passwd_note');
