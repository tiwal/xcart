 ...
 * @version    $Id: calculate_result.php,v 1.1.2.1 2012/04/06 10:34:25 ferz Exp $
...
if (func_taxcloud_is_module_enabled()) {
    ...
    if (!empty($cart['taxcloud_certificateID'])) {
        $return['taxcloud_certificateID'] = $cart['taxcloud_certificateID'];
    }

    if (!empty($cart['taxcloud_cartid'])) {
        $return['taxcloud_cartid'] = $cart['taxcloud_cartid'];
    }
}
