...
/**
 * Taxes calculation. Called from func_calculate_taxes (include/func/func.cart.php)
 *
 * @category   X-Cart
 * @package    X-Cart
 * @subpackage Modules
 ...
 * @version    $Id: taxes.php,v 1.1.2.1 2012/04/06 10:34:25 ferz Exp $
...
if (func_taxcloud_is_module_enabled()) {
    $taxes = func_taxcloud_get_tax_rates($products, $customer_info, $shipping_cost);
}
