 ...
 * @version    $Id: import_variants.php,v 1.38.2.6 2012/03/27 11:18:35 aim Exp $
 ...
 */
    ...
    foreach ($values['class'] as $k => $v) {
        ...
        if (is_null($_classid) && empty($import_file['drop']['product_options'])) {
        ...
        if (is_null($_optionid) && !empty($_classid) && empty($import_file['drop']['product_options'])) {
