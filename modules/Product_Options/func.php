 ...
 * @version    $Id: func.php,v 1.128.2.10.2.1 2012/04/17 09:00:35 aim Exp $
...
function func_get_options_amount($product_options, $productid)
{
    ...
    if (
        ...
        $classes = func_query_column("SELECT classid FROM $sql_tbl[classes] WHERE productid = '$productid' AND is_modifier = '' AND avail = 'Y'");
