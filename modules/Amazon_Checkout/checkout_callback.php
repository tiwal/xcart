 ...
 * @version    $Id: checkout_callback.php,v 1.8.2.8.2.1 2012/04/18 08:03:54 aim Exp $
...
if ($type == 'ORDERCALCULATIONSREQUEST') {
    ...
    @db_query("REPLACE INTO $sql_tbl[amazon_data] (ref,cart,sessid) VALUES ('$skey','".addslashes(serialize($cart))."','$XCARTSESSID')");
    x_session_save();
