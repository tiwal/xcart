 ...
 * @version    $Id: func.php,v 1.8.2.13.2.2 2012/04/20 06:59:14 aim Exp $
 * @since      4.4.0
 */
...
function pamp_get_current_symbol($avail_symbols)
{
    if (
        ...
        if (in_array($symb, $avail_symbols)) {
...
function pmap_get_products($symb)
{
    ...
    $query = " AND $sql_tbl[products_lng_current].product REGEXP '^[{$symb}]'";
