 ...
 * @version    $Id: config.php,v 1.26.2.5 2012/03/27 11:18:28 aim Exp $
...
func_image_cache_assign('D', 'dpicon');
func_image_cache_assign('D', 'dpthmbn');
...
if (defined('TOOLS')) {
    ...
    $tbl_demo_data['Detailed_Product_Images'] = array(
        'images_D' => 'images'
    );
}
