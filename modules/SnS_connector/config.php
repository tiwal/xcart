 ...
 * @version    $Id: config.php,v 1.23.2.5 2012/03/27 11:18:37 aim Exp $
...
$css_files['SnS_connector'][] = array();

x_session_register('sns_flag');

$sns_ext_actions = array();

$sns_extensions = array(
    'php' => 'PHP',
    'aspx' => 'ASP'
);
