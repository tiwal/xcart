...
/**
 * Stores necessary data within order details
 *
 * @category   X-Cart
 * @package    X-Cart
 * @subpackage Modules
 ...
 * @version    $Id: place_order_extra.php,v 1.12.2.4 2012/03/27 11:18:31 aim Exp $
...
if ($config['General']['enable_gift_wrapping'] == 'Y') {
    ...
    $_extra['giftwrap'] = array(
        ...
        'giftwrap_message'    => @$cart['giftwrap_message']
    );
