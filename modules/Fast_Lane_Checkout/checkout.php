 ...
 * @version    $Id: checkout.php,v 1.25.2.17 2012/03/27 11:18:29 aim Exp $
...
if (!empty($paymentid)) {
    ...
    if (
        ...
        && !$force_change_shipping
        && func_cart_is_single_CODpayment_selectable(@$payment_methods[0]['paymentid'], @$cart['shippingid'])
    ) {
...
if (
    empty($login)
    && !func_is_completed_userinfo($_anonymous_userinfo)
) {
