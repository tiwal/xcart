 ...
 * @version    $Id: returns.php,v 1.69.2.11.2.1 2012/04/06 13:01:29 aim Exp $
...
if ($mode == 'modify') {
    ...
    } elseif (!empty($search_data['returns']['orderid'])) {

        unset($search_data['returns']['orderid']);
