 ...
 * @version    $Id: func.php,v 1.27.2.7.2.1 2012/04/06 13:01:29 aim Exp $
...
function func_pconf_get_slot_data($slot)
{
    ...
    if (!empty($slot_data['default_productid'])) {
        ...
        $slot_data['default_product'] = func_query_first_cell("SELECT product FROM $sql_tbl[products_lng_current] WHERE productid = '".$slot_data["default_productid"]."'");
