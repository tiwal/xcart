 ...
 * @version    $Id: func.php,v 1.28.2.7 2012/03/27 11:18:36 aim Exp $
...
function func_usps_save_pack_configuration_slg($ship_packages_uniq, $provider, $pack, $previous_pack, $pack_limit_key, $previous_pack_limit_key)
{
    ...
    return array($ship_packages_uniq, $previous_pack, $previous_pack_limit_key);
}
