 ...
 * @version    $Id: init.php,v 1.179.2.37.2.3 2012/04/17 09:00:35 aim Exp $
 ...
 */
$_lngs = func_query_column("SHOW TABLES LIKE '${xcart_tbl_prefix}products_lng_%'") ;
...
*/
if (
    $config['General']['skip_log_phpini_changes'] != 'Y'
