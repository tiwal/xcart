 ...
 * @version    $Id: import_categories.php,v 1.54.2.10 2012/03/27 11:18:19 aim Exp $
 ...
 */
    ...
    if (!empty($import_file['drop']['categories'])) {
        ...
        foreach ($cats as $kc => $c) {
            ...
            if ($kc == count($cats)-1) {
                ...
                if (isset($category['title_tag']))
                    $data['title_tag'] = addslashes($category['title_tag']);
