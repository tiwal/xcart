 ...
 * @version    $Id: import.php,v 1.117.2.14 2012/03/27 11:18:19 aim Exp $
...
//]]></script>');
        ...
        for ($i = 0; $i < count($columns); $i++) {
            ...
            if (!zerolen($columns[$i])) {
                ...
                // Check data value
                    ...
                    // Data as formatted string
                        ...
                        $columns[$i] = func_strtotime($columns[$i]);
                ...
                if (
                    $col_type == 'S'
                    && !empty($import_specification[$section]['columns'][$colnames[$i]]['eol_safe'])
            ...
            if (
                ...
                if ($import_specification[$section]['columns'][$colnames[$i]]['type'] == "D") {
                    ...
                    if (!empty($import_specification[$section]['columns'][$colnames[$i]]['default'])) {
                        ...
                        $tmp = func_strtotime($import_specification[$section]['columns'][$colnames[$i]]['default']);
            ...
            if (
                ...
                && (
                    !$is_subrow
                    || !empty($import_specification[$section]['columns'][$colnames[$i]]['array'])
                )
            ) {
...
$import_data['options']['crypt_password'] = isset($import_data['options']['crypt_password']) ? $import_data['options']['crypt_password'] : 'Y';
