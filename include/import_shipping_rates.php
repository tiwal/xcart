 ...
 * @version    $Id: import_shipping_rates.php,v 1.27.2.6 2012/03/27 11:18:20 aim Exp $
 ...
 */
    ...
    // Import data...
        ...
        // Detect rateid
        $_rateid = func_query_first_cell("SELECT rateid FROM $sql_tbl[shipping_rates] WHERE zoneid = '$row[zoneid]' AND shippingid = '$row[shippingid]' $provider_condition AND mintotal = '$row[mintotal]' AND maxtotal = '$row[maxtotal]' AND minweight = '$row[minweight]' AND maxweight = '$row[maxweight]' AND type = '$row[type]'");
