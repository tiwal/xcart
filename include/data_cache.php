 ...
 * @version    $Id: data_cache.php,v 1.42.2.45.2.2 2012/04/17 09:00:34 aim Exp $
...
if (
    !defined('QUICK_START')
    && preg_match('/home.php|product.php/s', @$PHP_SELF)
) {
    ...
    if (
        ...
        sleep(mt_rand(0,2));
        if ((XC_TIME-func_query_first_cell("SELECT value FROM $sql_tbl[config] WHERE name='data_cache_expiration'")) > $_data_cache_ttl) {
...
function func_sort_active_modules($a, $b)
{
    static $sort_order = array(
        'Demo' => 0, # Demo module enables/disables other modules
        ...
        'Google_Checkout' => 6, #can be unsetted in config/init.php;Google_Checkout depends on Egoods
