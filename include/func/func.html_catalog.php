 ...
 * @version    $Id: func.html_catalog.php,v 1.40.2.10.2.1 2012/04/06 13:01:29 aim Exp $
...
function product_filename($productid, $prod_name=false){
    ...
    if (empty($prod_name))
        $prod_name = func_query_first_cell("SELECT product FROM $sql_tbl[products_lng_current] WHERE productid = '$productid'");
