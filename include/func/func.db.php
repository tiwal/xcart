 ...
 * @version    $Id: func.db.php,v 1.57.2.22.2.7 2012/04/18 09:21:52 aim Exp $
...
function func_transform_lng_query_base($query, $base_table, $current_lng_table)
{
    ...
    $reserved_words = array('use','inner','join','partition','ignore','force','cross','straight_join', 'left', 'right', 'outer', 'natural','order','where','limit','group','having','procedure','into');
