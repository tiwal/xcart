 ...
 * @version    $Id: func.payment.php,v 1.68.2.29.2.1 2012/04/10 09:41:35 aim Exp $
...
function func_check_webinput($check_php = 1)
{
    ...
    static $pfiles = array (
        ...
        'cc_paypointft.php' => array(
            'cc_paypointft_response.php',
            'cc_paypointft.php'
        ),
        'cc_pp3.php' => array (
            'ebank_ok.php',
    ...
    if ($allow_ip && !defined('DISABLE_IP_CHECK')) {
        $not_found = true;
        $a = explode(",", $allow_ip);
        foreach ($a as $v) {
...
function func_payment_do_refund($orderid, $total = null)
{
    ...
    if ($ret === true || (is_int($ret) && $ret > 0)) {
        ...
        func_order_process_refund($orderids, $total);
    }
...
function func_is_complex_processor($processor)
{
    return in_array(
        $processor,
        array(
            'cc_2conew.php', 'cc_worldpay.php', 'cc_asp.php', 'cc_anz.php',
            'cc_goem_pf.php', 'cc_ideal_rb_prof.php', 'cc_ideal_basic.php', 'cc_ideala.php',
            'cc_hsbc.php', 'cc_isecure.php', 'cc_mbookers.php',
            'cc_mbookers_wlt.php', 'cc_multicard.php', 'cc_netbanx.php', 'ps_nochex.php',
            'cc_ogoneweb.php', 'cc_pnpss.php', 'cc_pp3.php', 'cc_psigate.php',
            'cc_securetrading.php', 'cc_paypointft.php', 'cc_securetrading.php',
            'cc_csrc_form.php', 'cc_nab_transact.php'
        )
    );
}
