 ...
 * @version    $Id: func.core.php,v 1.328.2.88.2.7 2012/04/20 06:59:13 aim Exp $
    ...
    if ($cache_engine == 'pear::cache_lite') {
        ...
        if ($cache_lite) {
            ...
            if (!$data) {
                ...
                if (!empty($data_caches[$name]['func_is_valid']))
                    $is_valid = call_user_func_array($data_caches[$name]['func_is_valid'], array($data));
                else
                    $is_valid = true;
 ...
 * SYNCHRONIZE with definition in check_requirements.php
 */
...
function func_check_languages_flags($languages = null)
{
    ...
    assert('/*Func_check_languages_flags @params*/ 
...
function func_assert_failure_handler($file, $line, $code)
{
    ...
    echo "<hr>Assertion Failed:
        ...
        Code '$code'<br />Please post a new ticket here https://bugtracker.qtmsoft.com<br />Please, attach the $filename file to the ticket.<hr />.";
}
