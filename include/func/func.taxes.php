 ...
 * @version    $Id: func.taxes.php,v 1.39.2.12.2.1 2012/04/06 10:32:27 ferz Exp $
 ...
 */
function func_tax_price($price, $productid=0, $disable_abs=false, $discounted_price=NULL, $userid=0, $taxes="", $price_deducted_tax=false, $amount=1)
{
    ...
    if (is_array($taxes)) {
        ...
        foreach ($taxes as $k=>$tax_rate) {
            ...
            if (!empty($tax_rate['skip']) || (empty($userid) && $config['General']['apply_default_country'] != 'Y'))
                continue;
