 ...
 * @version    $Id: func.user.php,v 1.137.2.57.2.1 2012/04/16 07:07:57 ferz Exp $
 ...
 */
function func_userinfo($user, $usertype = '', $need_password = false, $need_cc = '', $profile_area = NULL, $merge_cart_info = true)
{
