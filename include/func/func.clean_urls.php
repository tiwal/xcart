 ...
 * @version    $Id: func.clean_urls.php,v 1.23.2.10.2.1 2012/04/06 13:01:28 aim Exp $
    ...
    if (!isset($resources_data)) {
        ...
        $resources_data = array(
            'P' => array(
                ...
                'resource_table'         => "$sql_tbl[products] AS p INNER JOIN $sql_tbl[products_lng_current] AS pl ON pl.productid=p.productid",
                'resource_table_alias'     => 'p',
                'resource_id_column'     => 'productid',
                'params'                 => array('pl.product', 'p.productcode'),
            ...
            'C' => array(
                ...
                'resource_table_alias'         => $sql_tbl['categories'],
            ...
            'M' => array(
                ...
                'resource_table_alias'         => $sql_tbl['manufacturers'],
            ...
            'S' => array(
                ...
                'resource_table_alias'         => $sql_tbl['pages'],
...
function func_clean_url_get_missing_urls_stats()
{
    ...
    foreach ($resources_data as $resource_type => $resource) {
        ...
        $missing_count = func_query_first_cell("SELECT COUNT(*) FROM " . $resource['resource_table'] . " LEFT JOIN " . $sql_tbl['clean_urls'] . " ON " . $sql_tbl['clean_urls'] . ".resource_type = '" . $resource_type . "' AND " . $sql_tbl['clean_urls'] . ".resource_id = " . $resource['resource_table_alias'] . "." . $resource['resource_id_column'] . " WHERE " . $sql_tbl['clean_urls'] . ".resource_id IS NULL");
