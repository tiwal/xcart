 ...
 * @version    $Id: atracking.php,v 1.48.2.8 2012/04/02 10:50:47 aim Exp $
...
function update_statistics()
{
    ...
    global $config, $clean_url_data, $xcart_web_dir, $XCART_SESSION_NAME;
    ...
    $page = substr(addslashes($page), 0, 255);
    $page = rtrim($page, '\\');
...
{
    global $stats_transactionid, $stats_transaction_step, $cart;
    global $mode, $paymentid, $logged_userid, $sql_tbl, $action, $is_anonymous;
