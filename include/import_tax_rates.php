 ...
 * @version    $Id: import_tax_rates.php,v 1.34.2.6 2012/03/27 11:18:20 aim Exp $
 ...
 */
    ...
    if (!empty($values['tax'])) {
        ...
        if (is_null($_taxid) && empty($import_file['drop']['taxes'])) {
 ...
 */
    ...
    if (!empty($import_file['drop']['tax_rates'])) {
