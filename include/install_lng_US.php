 ...
 * @version    $Id: install_lng_US.php,v 1.85.2.21.2.2 2012/04/16 11:36:27 aim Exp $
...
$install_languages["US"] = array (
    ...
    "contact_for_help_link" => "Contact X-Cart for help",
    "contact_for_help_text" => "Contact X-Cart for help",
    "username" => "username",
    "password" => "password",
    ...
    "auth_code" => "Auth code",
    "auth_code_note" => "This is a protection from unauthorized use of the installation script.<br /><br />The Auth code is included in the e-mail message you have received upon the X-Cart installation. If you do not have this e-mail message and do not know the Auth code, find the code in the \"Summary\" section of your store's Admin area or in the config.php file, in the installation_auth_code variable.",
    ...
    "thank_you_for_contact" => "Thank you for contacting us.<br /> Someone from our staff will contact you at the earliest opportunity.<br /><br />You can find more information about X-Cart software at X-Cart: Frequently asked questions page.<br />Also, you can find X-Cart knowledge base at http://help.x-cart.com",
    ...
    "copyright_text" => "&copy; 2001-2012 X-Cart.com<br />&copy; 2001-2012 Qualiteam software Ltd &lt;info@x-cart.com&gt;",
    ...
    "mod_cfg_enable_generate_snapshot" => "Generating a system fingerprint",
    ...
    "title_enable_generate_snapshot" => "System fingerprint",
    ...
    "techrep_intro" => '<p>Please use below form to send installation errors report to us and we will contact you to help as soon as we can.</p><p>You can find more information about X-Cart software at http://help.x-cart.com page.</p>',
    ...
    // module_check_cfg
    "checking_results" => "Inspecting server configuration",
    ...
    "permissions_descr" => '<p>Here is a list of files/directories that failed permissions check:</p>{{value}}<p>You can find more information about X-Cart software at X-Cart: Frequently asked questions page.</p>',
    "non_critical_permissions_descr" => '<p>Here is a list of files/directories that failed permissions check:</p>{{value}}<p>You can find more information about X-Cart software at X-Cart: Frequently asked questions page.</p>',
    ...
    "install_mysql_min_version" => "MySQL v4.1.2 or later is required for X-Cart to work properly (versions
    ...
    "install_demodata" => "<b>Example data</b><br />Would you like to setup example categories,products and payment/shipping methods?",
    ...
    "error_connect" => "Can't connect to the MySQL server. Please, check database info again",
    ...
    "warning_db_has_non_xcart_tables" => "MySQL default character set will be changed to UTF-8 Unicode for your database",
    ...
    "installation_can_be_cont" => "(Installation can be continued)",
    ...
    "install_web_paypal_comment" => "<p>After you click on 'Next' a verification message will be sent to the email address specified here. Please follow the web link in this message to enable PayPal payments in your store.</p><b>Notes:</b><ol><li>Please make sure the spam filter on this mail box is configured to accept notifications from PayPal &amp; X-Cart.</li><li>PayPal and other payment gateways can be configured on the \"Payment methods\" page in X-Cart administrator area at any time later.</li></ol>",

    // mod_cfg_enable_generate_snapshot
    "generate_snapshots_question" => "Do you wish to generate snapshots now?",
    "generate_snapshots_tooltip" => 'The generation of a system fingerprint is a lengthy process, and on some servers it may be terminated early. In this case, the installation of the store will not be completed. You can generate a system fingerprint from the admin area after the installation of the store. X-Cart:System Fingerprints',
