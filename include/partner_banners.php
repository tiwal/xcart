 ...
 * @version    $Id: partner_banners.php,v 1.25.2.10 2012/03/27 11:18:21 aim Exp $
...
} elseif(!empty($current_partner))
    $smarty->assign('current_partner', $current_partner);
