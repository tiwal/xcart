 ...
 * @version    $Id: history_order.php,v 1.68.2.7 2012/03/27 11:18:19 aim Exp $
    ...
    if ($orders) {
        ...
        foreach ($orders as $orderid) {
            ...
            if (
                ...
                if (!empty($order_data['order']['access_key'])) {
                    if ($order_data['order']['access_key'] != @$access_key)
                        func_403(34);
                } else {
                    if ($order_data['userinfo']['userid'] != $logged_userid)
                        func_403(34);
                }    
            }
