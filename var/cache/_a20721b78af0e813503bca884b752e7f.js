...
var store_language = 'zh';
var xcart_web_dir = "";
var images_dir = "/skin/common_files/images";
var alt_images_dir = "/skin/ideal_comfort/images";var lbl_no_items_have_been_selected = 'No items have been selected';
var current_area = 'C';
var currency_format = "NZDx";
...
var txt_ajax_error_note = 'An error occurred while processing a request. Please refresh the page.If the problem still persists after refreshing the page please contact us on the matter.';
var txt_email_invalid = "Email address is invalid! Please correct";
var email_validation_regexp = new RegExp("^[a-z0-9!#$%&\'*+\\/=?^_`{|}~-]+(?:\\.[a-z0-9!#$%&\'*+\\/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z](?:[a-z0-9-]*[a-z0-9])$", "gi");
var is_admin_editor = false;
var catalogs = {
  admin: "http://congcewang.com/admin",
  provider: "http://congcewang.com/provider",
  customer: "http://congcewang.com",
  partner: "http://congcewang.com/partner",
  images: "/skin/common_files/images",
  skin: "/skin/common_files"
};
var lng_labels = [];
lng_labels['lbl_included_templates_config_files'] = "Included templates &amp; config files";
lng_labels['lbl_xcart_debugging_console'] = "Debugging Console";
 ...
 * @version    $Id: common.js,v 1.13.2.8 2012/03/27 11:18:45 aim Exp $
 ...
 * @subpackage JS Library
 * @author     Ruslan R. Fazlyev <rrf@x-cart.com> 
 * @version    $Id: popup_open.js,v 1.20.2.5 2012/02/06 12:41:05 aim Exp $
 * @link       http://www.x-cart.com/
 * @see        ____file_see____
 */
