...
<?php if ($this->webmaster_mode) { ?><div id="common_files0location.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "location.tpl","txt_noscript_warning,lbl_go_to_last_edit_section,lbl_close"); ?><?php if ($this->_tpl_vars['location'] != ""): ?>
