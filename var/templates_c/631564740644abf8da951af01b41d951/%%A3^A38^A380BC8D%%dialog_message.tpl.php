...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0dialog_message.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/dialog_message.tpl","lbl_close,lbl_go_to_last_edit_section"); ?><?php if ($this->_tpl_vars['top_message']['content'] != "" || $this->_tpl_vars['alt_content'] != ""): ?>
