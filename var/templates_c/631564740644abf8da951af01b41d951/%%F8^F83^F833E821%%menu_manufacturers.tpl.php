...
<?php if ($this->webmaster_mode) { ?><div id="common_files0modules0Manufacturers0menu_manufacturers.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "modules/Manufacturers/menu_manufacturers.tpl","lbl_other_manufacturers,lbl_manufacturers"); ?><?php if ($this->_tpl_vars['manufacturers_menu'] != ''): ?>
