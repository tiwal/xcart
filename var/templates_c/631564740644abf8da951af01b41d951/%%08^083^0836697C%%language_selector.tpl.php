...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0language_selector.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/language_selector.tpl","lbl_select_language"); ?><?php if ($this->_tpl_vars['all_languages_cnt'] > 1): ?>
