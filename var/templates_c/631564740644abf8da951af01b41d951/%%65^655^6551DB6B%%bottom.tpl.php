...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'amp', 'bottom.tpl', 35, false),)), $this); ?>
<?php if ($this->webmaster_mode) { ?><div id="common_files0bottom.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "bottom.tpl","lbl_language"); ?><table width="100%" cellpadding="0" cellspacing="0">
<?php if ($this->_tpl_vars['active_modules']['Users_online'] != "" || $this->_tpl_vars['all_languages_cnt'] > 1): ?>
<tr>
  <td>
  <table width="100%">
    <tr>
