...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0main0login_link.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/main/login_link.tpl","lbl_sign_in,lbl_sign_in"); ?><a href="<?php echo $this->_tpl_vars['authform_url']; ?>
...
"<?php endif; ?> id="href_Sign_in"><?php echo $this->_tpl_vars['lng']['lbl_sign_in']; ?>
