...
<?php if ($this->webmaster_mode) { ?><div id="common_files0dialog_tools_cell.tpl10" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php if ($this->_tpl_vars['cell']['separator']): ?>
