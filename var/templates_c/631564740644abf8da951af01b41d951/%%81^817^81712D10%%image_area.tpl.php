...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0image_area.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/image_area.tpl","lbl_product_images,lbl_modified,lbl_no_image_uploaded,lbl_upload_thumbnail,lbl_upload_image,lbl_image,lbl_save,lbl_no_image_uploaded,lbl_change_image,lbl_upload_image,lbl_reset_image,lbl_delete_image,lbl_thumbnail,lbl_save,lbl_no_thumbnail_uploaded,txt_need_thumbnail_help,lbl_thumbnail_msg,lbl_change_thumbnail,lbl_upload_thumbnail,lbl_generate_thumbnail,lbl_reset_thumbnail,lbl_delete_thumbnail,lbl_close,lbl_product_image_save_msg,lbl_save,lbl_auto_resize_no_gd_library"); ?><tr>
