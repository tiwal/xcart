...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0category_selector.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/category_selector.tpl","lbl_please_select_category"); ?><script type="text/javascript">
//<![CDATA[
...
</select><?php if ($this->webmaster_mode) { ?></div><?php } ?>