...
<?php if ($this->webmaster_mode) { ?><div id="common_files0modules0Special_Offers0product_modify.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "modules/Special_Offers/product_modify.tpl","lbl_sp_apply_offers_discounts,lbl_sp_give_bp_for_each_item"); ?><tr>
...
</tr><?php if ($this->webmaster_mode) { ?></div><?php } ?>