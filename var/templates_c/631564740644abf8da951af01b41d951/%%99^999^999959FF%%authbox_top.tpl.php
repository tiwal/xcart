...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substitute', 'authbox_top.tpl', 15, false),array('modifier', 'amp', 'authbox_top.tpl', 15, false),array('modifier', 'wm_remove', 'authbox_top.tpl', 17, false),array('modifier', 'escape', 'authbox_top.tpl', 17, false),)), $this); ?>
<?php if ($this->webmaster_mode) { ?><div id="common_files0authbox_top.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "authbox_top.tpl","lbl_your_partner_id,lbl_close_storefront,lbl_open,lbl_open_storefront,lbl_open_storefront_warning,lbl_close,lbl_logoff,lbl_keywords,lbl_search,txt_how_quick_search_works"); ?><table cellpadding="2" cellspacing="0" border="0">
<tr>
