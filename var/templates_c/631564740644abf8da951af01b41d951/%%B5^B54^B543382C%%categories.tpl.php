...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0categories.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/categories.tpl","lbl_categories"); ?><?php if ($this->_tpl_vars['categories_menu_list'] != '' || $this->_tpl_vars['fancy_use_cache']): ?>
<?php ob_start(); ?>
