...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0textarea.tpl1" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/textarea.tpl","lbl_default_editor,lbl_default_editor,lbl_advanced_editor,lbl_advanced_editor"); ?><?php if ($this->_tpl_vars['active_modules']['HTML_Editor'] && ! $this->_tpl_vars['html_editor_disabled']): ?>
