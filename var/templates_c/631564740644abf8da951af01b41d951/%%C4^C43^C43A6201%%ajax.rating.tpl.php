...
<?php if ($this->webmaster_mode) { ?><div id="common_files0modules0Customer_Reviews0ajax.rating.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "modules/Customer_Reviews/ajax.rating.tpl","lbl_rated,lbl_error,lbl_cancel_vote"); ?><?php if (! ( $_COOKIE['robot'] == 'X-Cart Catalog Generator' && $_COOKIE['is_robot'] == 'Y' )): ?>
<?php ob_start(); ?>
