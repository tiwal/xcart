...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0edit_product_image.tpl1" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/edit_product_image.tpl","lbl_view_full_size"); ?><?php if ($this->_tpl_vars['idtag'] == ''): ?><?php $this->assign('idtag', 'edit_image'); ?><?php endif; ?>
