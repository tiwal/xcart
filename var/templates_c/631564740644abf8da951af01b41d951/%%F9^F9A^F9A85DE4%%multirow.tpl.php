...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0multirow.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/multirow.tpl","lbl_remove_row,lbl_add_row"); ?><script type="text/javascript" language="JavaScript 1.2">
//<![CDATA[
...
/js/multirow.js"></script><?php if ($this->webmaster_mode) { ?></div><?php } ?>