...
<?php if ($this->webmaster_mode) { ?><div id="common_files0dialog_tools.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "dialog_tools.tpl","lbl_go_to_last_edit_section,lbl_in_this_section,lbl_see_also"); ?><?php if ($this->_tpl_vars['dialog_tools_data']): ?>
