...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0product_modify.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/product_modify.tpl","lbl_sku,lbl_product,lbl_product_list,txt_edit_product_group,txt_add_product_options_note,lbl_product_options_help,txt_cant_create_product_warning,lbl_register_provider,lbl_warning"); ?><a name="main"></a>
