...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0search_sort_by.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/search_sort_by.tpl","lbl_sort_by,lbl_sort_by,lbl_sort_by"); ?><?php if ($this->_tpl_vars['sort_fields'] && ( $this->_tpl_vars['url'] || $this->_tpl_vars['navigation_script'] )): ?>
