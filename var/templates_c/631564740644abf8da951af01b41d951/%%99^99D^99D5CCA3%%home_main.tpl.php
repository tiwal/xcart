...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0home_main.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php if ($_GET['mode'] == 'subscribed'): ?>
