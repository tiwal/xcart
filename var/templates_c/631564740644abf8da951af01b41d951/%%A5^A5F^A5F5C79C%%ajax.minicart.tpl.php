...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0ajax.minicart.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/ajax.minicart.tpl","lbl_error,txt_minicart_total_note"); ?><?php if (! ( $_COOKIE['robot'] == 'X-Cart Catalog Generator' && $_COOKIE['is_robot'] == 'Y' )): ?>
<?php ob_start(); ?>
