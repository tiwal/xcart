...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0start_textarea.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><script type="text/javascript">
//<![CDATA[
