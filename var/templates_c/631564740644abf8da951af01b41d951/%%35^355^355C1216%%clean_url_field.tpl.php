...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0clean_url_field.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/clean_url_field.tpl","lbl_clean_url,lbl_clean_url_what_is,txt_clean_url_descr,lbl_clean_url_save_old,lbl_clean_url_manage_history,lbl_clean_url_format_warning,lbl_clean_url_format_warning_provider,lbl_clean_url_disabled_mode_warning,lbl_clean_url_disabled_mode_warning_provider"); ?><tr>
