...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substitute', 'admin/main/configuration.tpl', 9, false),array('modifier', 'escape', 'admin/main/configuration.tpl', 26, false),array('modifier', 'default', 'admin/main/configuration.tpl', 179, false),array('modifier', 'formatnumeric', 'admin/main/configuration.tpl', 207, false),array('modifier', 'strip_tags', 'admin/main/configuration.tpl', 347, false),array('function', 'getvar', 'admin/main/configuration.tpl', 67, false),array('function', 'cycle', 'admin/main/configuration.tpl', 170, false),array('function', 'assign_ext', 'admin/main/configuration.tpl', 247, false),array('function', 'inc', 'admin/main/configuration.tpl', 263, false),array('function', 'load_defer', 'admin/main/configuration.tpl', 357, false),)), $this); ?>
<?php if ($this->_tpl_vars['htaccess_warning'][$this->_tpl_vars['option']] == 'Y'): ?>
...
<?php if ($this->_tpl_vars['option'] == 'TaxCloud'): ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/TaxCloud/config.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['option'] == 'Company'): ?>
  <?php if ($_COOKIE['hide_company_adv'] == ''): ?>
    <?php echo smarty_function_load_defer(array('file' => "js/admin/show_company_adv.js",'type' => 'js'), $this);?>
