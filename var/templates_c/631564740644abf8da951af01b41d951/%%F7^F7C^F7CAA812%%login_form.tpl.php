<?php /* Smarty version 2.6.26, created on 2015-12-02 18:38:50
...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0login_form.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/login_form.tpl","lbl_password,msg_err_antibot,lbl_submit,lbl_recover_password,lbl_register"); ?><form action="<?php echo $this->_tpl_vars['authform_url']; ?>
