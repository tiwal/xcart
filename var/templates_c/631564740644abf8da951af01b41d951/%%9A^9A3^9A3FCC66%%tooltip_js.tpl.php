...
" <?php if ($this->_tpl_vars['ajax_source']): ?>rel="<?php echo $this->_tpl_vars['ajax_source']; ?>
"<?php else: ?>rel="#<?php echo ((is_array($_tmp=@$this->_tpl_vars['id'])) ? $this->_run_mod_handler('default', true, $_tmp, 'tooltip_link') : smarty_modifier_default($_tmp, 'tooltip_link')); ?>
_tooltip"<?php endif; ?>><?php echo ((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['lng']['lbl_need_help']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['lng']['lbl_need_help'])); ?>
</a>
  </label>
...
"<?php endif; ?> <?php if ($this->_tpl_vars['ajax_source']): ?>rel="<?php echo $this->_tpl_vars['ajax_source']; ?>
"<?php else: ?>rel="#<?php echo ((is_array($_tmp=@$this->_tpl_vars['id'])) ? $this->_run_mod_handler('default', true, $_tmp, 'tooltip_link') : smarty_modifier_default($_tmp, 'tooltip_link')); ?>
_tooltip"<?php endif; ?>>
...
_tooltip" <?php if ($this->_tpl_vars['ajax_source']): ?>rel="<?php echo $this->_tpl_vars['ajax_source']; ?>
"<?php else: ?>rel="#<?php echo ((is_array($_tmp=@$this->_tpl_vars['id'])) ? $this->_run_mod_handler('default', true, $_tmp, 'tooltip_link') : smarty_modifier_default($_tmp, 'tooltip_link')); ?>
_tooltip"<?php endif; ?>><?php echo ((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['lng']['lbl_need_help']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['lng']['lbl_need_help'])); ?>
</a>
...
').cluetip({
    local: <?php if ($this->_tpl_vars['ajax_source']): ?>false<?php else: ?>true<?php endif; ?>,
    hideLocal: false,
...
<?php echo smarty_function_load_defer(array('file' => "tooltip".($this->_tpl_vars['id']),'direct_info' => $this->_tpl_vars['tt'],'type' => 'js'), $this);?>
