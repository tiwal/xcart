...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'main/register_personal_info.tpl', 26, false),array('modifier', 'truncate', 'main/register_personal_info.tpl', 101, false),)), $this); ?>
<?php if ($this->_tpl_vars['is_areas']['P'] == 'Y'): ?>
<?php if ($this->_tpl_vars['hide_header'] == ""): ?>
<tr>
<td colspan="3" class="RegSectionTitle"><?php echo $this->_tpl_vars['lng']['lbl_personal_information']; ?>
...
<tr>
<td align="right" class="data-name"><label for="title"><?php echo $this->_tpl_vars['lng']['lbl_title']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><label for="firstname"><?php echo $this->_tpl_vars['lng']['lbl_first_name']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><label for="lastname"><?php echo $this->_tpl_vars['lng']['lbl_last_name']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><label for="company"><?php echo $this->_tpl_vars['lng']['lbl_company']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><label for="ssn"><?php echo $this->_tpl_vars['lng']['lbl_ssn']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><label for="url"><?php echo $this->_tpl_vars['lng']['lbl_web_site']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><label for="tax_number"><?php echo $this->_tpl_vars['lng']['lbl_tax_number']; ?>
</label></td>
...
<tr>
<td align="right" class="data-name"><?php echo $this->_tpl_vars['lng']['lbl_tax_exemption']; ?>
</td>
<td>&nbsp;</td>
<td nowrap="nowrap">
...
<?php if ($this->_tpl_vars['usertype'] == 'A' || $this->_tpl_vars['usertype'] == 'P'): ?>
<tr>
<td align="right" class="data-name"><?php echo $this->_tpl_vars['lng']['lbl_referred_by']; ?>
</td>
<td></td>
<td nowrap="nowrap">
<?php if ($this->_tpl_vars['userinfo']['referer']): ?>
<a href="<?php echo $this->_tpl_vars['userinfo']['referer']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['referer'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 80, ".....", false, true) : smarty_modifier_truncate($_tmp, 80, ".....", false, true)); ?>
</a>
<?php else: ?>
