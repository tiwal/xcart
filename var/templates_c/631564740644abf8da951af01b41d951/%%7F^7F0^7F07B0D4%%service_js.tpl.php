...
<?php echo smarty_function_getvar(array('func' => 'func_tpl_is_acheckout_button_enabled'), $this);?>

<?php if ($this->_tpl_vars['func_tpl_is_acheckout_button_enabled']): ?>
  <script type="text/javascript" src="<?php echo $this->_tpl_vars['amazon_widget_url']; ?>
"></script>
<?php endif; ?>  
...
<?php if ($this->_tpl_vars['config']['UA']['browser'] == 'MSIE'): ?>
  ...
  <?php if ($this->_tpl_vars['ie_ver'] < '7'): ?>
    <?php echo smarty_function_load_defer(array('file' => "customer/iefix.js",'type' => 'js'), $this);?>

  <?php endif; ?>
<?php endif; ?>

<?php if ($this->_tpl_vars['active_modules']['Google_Analytics'] && $this->_tpl_vars['config']['Google_Analytics']['ganalytics_version'] == 'Asynchronous'): ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Google_Analytics/ga_code_async.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>