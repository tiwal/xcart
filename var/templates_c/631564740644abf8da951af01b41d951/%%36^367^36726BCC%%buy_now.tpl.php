...
<?php if ($this->webmaster_mode) { ?><div id="ideal_comfort0customer0main0buy_now.tpl3" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/main/buy_now.tpl","lbl_qty,txt_out_of_stock,lbl_product_quantity_from_to,txt_out_of_stock,lbl_add_to_wl,lbl_add_to_wl,lbl_add_to_wl,lbl_add_to_wl,txt_need_min_amount"); ?><div class="buy-now">
...
/custom/right_corners.gif" alt=""/>
          <span class="quantity-title"><?php echo $this->_tpl_vars['lng']['lbl_qty']; ?>
</span>
...
<?php echo $this->_tpl_vars['featured']; ?>
" name="amount" maxlength="11" size="1" onchange="javascript: return check_quantity(<?php echo $this->_tpl_vars['product']['productid']; ?>
, '<?php echo $this->_tpl_vars['featured']; ?>
...
"<?php if ($this->_tpl_vars['smarty_get_quantity'] == $this->_sections['quantity']['index']): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['quantity']['index']; ?>
    ...
    <?php elseif ($this->_tpl_vars['product']['appearance']['empty_stock'] && ! $this->_tpl_vars['product']['variantid']): ?>
      ...
      <div class="quantity"><img class="left_crns_qty" src="<?php echo $this->_tpl_vars['AltImagesDir']; ?>
/custom/left_corners.gif" alt=""/><img class="right_crns_qty" src="<?php echo $this->_tpl_vars['AltImagesDir']; ?>
/custom/right_corners.gif" alt=""/><strong><?php echo $this->_tpl_vars['lng']['txt_out_of_stock']; ?>
</strong></div>
...
" onclick="javascript: submitForm(document.orderform_<?php echo $this->_tpl_vars['product_key']; ?>
, 'add2wl'); return false;" href="javascript: void(0);">
...
"/>
  ...
  <?php if ($this->_tpl_vars['active_modules']['Socialize'] && $this->_tpl_vars['is_matrix_view']): ?>
