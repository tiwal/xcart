...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'trim', 'customer/special.tpl', 36, false),)), $this); ?>
<?php if ($this->webmaster_mode) { ?><div id="ideal_comfort0customer0special.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/special.tpl","lbl_manufacturers,lbl_special"); ?><?php ob_start(); ?>
