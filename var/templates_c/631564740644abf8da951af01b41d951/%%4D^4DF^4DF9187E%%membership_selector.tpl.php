...
<?php if ($this->webmaster_mode) { ?><div id="common_files0main0membership_selector.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "main/membership_selector.tpl","lbl_all,lbl_hold_ctrl_key"); ?><?php if ($this->_tpl_vars['field'] == ''): ?>
