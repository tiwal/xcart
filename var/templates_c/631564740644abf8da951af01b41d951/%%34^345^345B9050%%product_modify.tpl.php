...
<?php if ($this->webmaster_mode) { ?><tbody id="common_files0modules0Extra_Fields0product_modify.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php $_from = $this->_tpl_vars['extra_fields']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['exf'] = array('total' => count($_from), 'iteration' => 0);
...
<?php endforeach; endif; unset($_from); ?><?php if ($this->webmaster_mode) { ?></tbody><?php } ?>