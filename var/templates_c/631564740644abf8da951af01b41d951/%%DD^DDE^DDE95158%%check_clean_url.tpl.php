...
<?php if ($this->webmaster_mode) { ?><div id="common_files0check_clean_url.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "check_clean_url.tpl","err_clean_url_wrong_format"); ?><script type="text/javascript">
//<![CDATA[
...
/js/check_clean_url.js"></script><?php if ($this->webmaster_mode) { ?></div><?php } ?>