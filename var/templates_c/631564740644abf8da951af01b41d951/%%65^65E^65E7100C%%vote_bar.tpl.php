...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substitute', 'modules/Customer_Reviews/vote_bar.tpl', 6, false),array('modifier', 'escape', 'modules/Customer_Reviews/vote_bar.tpl', 6, false),array('function', 'load_defer', 'modules/Customer_Reviews/vote_bar.tpl', 36, false),array('function', 'load_defer_code', 'modules/Customer_Reviews/vote_bar.tpl', 51, false),)), $this); ?>
<?php if ($this->webmaster_mode) { ?><div id="common_files0modules0Customer_Reviews0vote_bar.tpl3" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "modules/Customer_Reviews/vote_bar.tpl","txt_rating_note,lbl_not_rated_yet,txt_you_have_rated_this_product,lbl_sign_in_to_rate"); ?><div class="creviews-rating-box">
...
<?php if ($this->_tpl_vars['vote_bar_standalone']): ?>
