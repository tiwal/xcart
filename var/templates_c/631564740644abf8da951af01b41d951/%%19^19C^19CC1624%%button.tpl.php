...
<?php endif; ?>" type="<?php if ($this->_tpl_vars['type'] == 'input'): ?>submit<?php else: ?>button<?php endif; ?>"<?php if (! notitle): ?> title="<?php echo ((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['button_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['button_title'])))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php else: ?> title="<?php echo ((is_array($_tmp=$this->_tpl_vars['tips_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?><?php if ($this->_tpl_vars['js_link']): ?> onclick="<?php echo $this->_tpl_vars['js_link']; ?>
"<?php endif; ?><?php if ($this->_tpl_vars['button_id']): ?> id="<?php echo ((is_array($_tmp=$this->_tpl_vars['button_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?>>
