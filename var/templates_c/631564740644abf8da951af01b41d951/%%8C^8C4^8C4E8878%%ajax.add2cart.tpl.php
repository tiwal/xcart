...
<?php if ($this->webmaster_mode) { ?><div id="common_files0customer0ajax.add2cart.tpl" onmouseover="javascript: dmo(this, event);" class="section"><?php } ?><?php func_load_lang($this, "customer/ajax.add2cart.tpl","lbl_added,lbl_error"); ?><?php if (! ( $_COOKIE['robot'] == 'X-Cart Catalog Generator' && $_COOKIE['is_robot'] == 'Y' )): ?>
<?php ob_start(); ?>
