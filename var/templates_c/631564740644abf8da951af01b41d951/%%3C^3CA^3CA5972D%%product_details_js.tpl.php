...
<?php func_load_lang($this, "main/product_details_js.tpl","lbl_sku,lbl_product_name,lbl_clean_url,lbl_description,lbl_description"); ?><script type="text/javascript">
//<![CDATA[
var requiredFields = [
...
", false],
  ['product_lng[product]', "<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['lng']['lbl_description'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('wm_remove', true, $_tmp) : smarty_modifier_wm_remove($_tmp)))) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
", false]
];
