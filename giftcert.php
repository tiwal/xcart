 ...
 * @version    $Id: giftcert.php,v 1.46.2.10 2012/03/27 11:18:13 aim Exp $
...
if (
    ...
    if ($send_via == 'E') {
        ...
        $giftcert = array (
            ...
            'recipient_county'      => empty($recipient_county) ? '' : stripslashes($recipient_county),
            'recipient_countyname'  => empty($recipient_county) ? '' : func_get_county($recipient_county),
