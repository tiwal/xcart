 ...
 * @version    $Id: pconf.php,v 1.24.2.4 2012/03/27 11:18:14 aim Exp $
...
if (!empty($product_info)) {
    ...
    $location[] = array(
        ...
        "product.php?productid=$productid",
    );

    include $xcart_dir . '/modules/Product_Configurator/pconf_customer_step.php';
...
$smarty->assign('main_mode',    'customer');
