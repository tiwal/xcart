 ...
 * @version    $Id: tools.php,v 1.121.2.21.2.2 2012/04/17 08:18:08 aim Exp $
...
if (
    ...
    if (
        ...
        if (isset($tbls_to_delete['variants'])) {
            ...
            if (isset($tbls_to_delete['pricing']))
                ...
                $tbls_to_delete['pricing'] = " variantid > '0'";
    ...
    foreach ($sql_tbl as $tbl_alias => $table) {
        if (strpos($table, $xcart_tbl_prefix . 'products_lng_') === false)
            continue;
