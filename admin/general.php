 ...
 * @version    $Id: general.php,v 1.114.2.9.2.1 2012/04/06 13:01:27 aim Exp $
 ...
 */
$empty_prices = func_query_first_cell("SELECT COUNT(*) FROM $sql_tbl[products] INNER JOIN $sql_tbl[quick_prices] INNER JOIN $sql_tbl[pricing] WHERE $sql_tbl[products].productid = $sql_tbl[quick_prices].productid AND $sql_tbl[pricing].priceid = $sql_tbl[quick_prices].priceid AND $sql_tbl[pricing].price = '0.00' AND $sql_tbl[products].product_type != 'C'");
