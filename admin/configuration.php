 ...
 * @version    $Id: configuration.php,v 1.161.2.31 2012/03/27 11:18:15 aim Exp $
...
if (isset($_POST['wibiya_integration_code']))
...
if ($option == 'User_Profiles') {
   ...
   include $xcart_dir . '/modules/Mailchimp_Subscription/configuration.php';
    ...
    $clear_arr = array(
        'General' => array('speedup_js', 'speedup_css', 'use_cached_lng_vars', 'skip_delete_empty_strings', 'ajax_add2cart', 'redirect_to_cart', 'skip_check_compile', 'check_main_category_only', 'skip_categories_checking', 'use_simple_product_sort', 'skip_lng_tables_join', 'use_cached_templates','unlimited_products'),
...
foreach ($configuration as $k => $v) {
    ...
    switch ($v['name']) {
        ...
        case 'show_cart_details':
            $configuration[$k]['pre_note'] = func_get_langvar_by_name("txt_adv_mcaffe_add_secure_mark");
