 ...
 * @version    $Id: payment_methods.php,v 1.67.2.19.2.2 2012/04/10 09:41:36 aim Exp $
...
$cc_module_files = func_query("(select * from $sql_tbl[ccprocessors] where paymentid='0' and processor<>'ps_paypal_pro.php' order by type,module_name) $possible_xp_ccprocessors order by type,module_name");
...
if ($config['Company']['location_country'] == 'GB') {
    $dialog_tools_data['left'][] = array(
        'link' => "http://anonym.to/http://www.x-cart.com/sagepay.html",
