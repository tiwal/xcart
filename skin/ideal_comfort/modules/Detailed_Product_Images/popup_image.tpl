{*
$Id: popup_image.tpl,v 1.1.1.1 2012/04/05 10:16:14 ferz Exp $
...
//]]>
  ...
  <a href="popup_image.php?type=D&amp;id={$product.productid}" onclick="javascript: setTimeout(function() {ldelim}imagesPreviewShow('dpi', dpimages, dpioptions);{rdelim}, 200); return false;" target="_blank">{$lng.lbl_view_detailed_images|substitute:"counter":$images_counter}
