{*
$Id: register.tpl,v 1.4.2.9 2012/02/01 10:48:25 aim Exp $
...
//]]>
          ...
          <tbody>
            ...
            <tr>
              ...
              {if $login ne "" && $main eq "register"}
                ...
                <td class="register-button-row">{include file="customer/buttons/button.tpl" button_title=$lng.lbl_delete_profile href="register.php?mode=delete" style="link" additional_button_class="simple-delete-button"}</td>
                <td colspan="2" class="register-button-row">
              ...
              {else}
                ...
                <td colspan="3" class="register-button-row center">
                  <div class="center">
                    {if $smarty.get.action eq "cart"}
                      {include file="customer/buttons/submit.tpl" type="input" additional_button_class="main-button" button_title=$lng.lbl_submit_n_checkout}
                    {else}
  ...
  {/capture}
  {include file="customer/dialog.tpl" title=false content=$smarty.capture.dialog noborder=true}
