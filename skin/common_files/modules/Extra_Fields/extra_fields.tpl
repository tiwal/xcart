{*
$Id: extra_fields.tpl,v 1.3.2.1 2011/12/20 09:58:44 aim Exp $
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td><input type="text" name="posted_data[{$id}][service_name]" maxlength="128" size="15" value="{$field.service_name|escape}" /></td>
...
<tr>
  ...
  <td><input type="text" name="new[service_name]" maxlength="128" size="15" value="{$max_service_name|escape}" /></td>
