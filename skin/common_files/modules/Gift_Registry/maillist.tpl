{*
$Id: maillist.tpl,v 1.1.2.1 2011/12/20 09:58:44 aim Exp $
    ...
    <table cellspacing="1" class="data-table width-100">
      ...
      {foreach from=$mailing_list item=r}
        ...
        <tr{cycle values=', class="subhead-row"'}>
          ...
          <td><input type="text" size="26" maxlength="128" name="recipient_details[{$r.regid}][recipient_email]" value="{$r.recipient_email|escape}" /></td>
          <td>
            {if $r.status eq "P"}
              {$lng.lbl_pending}
  ...
  {if $recipients_limit_reached eq ""}
    ...
    <table cellspacing="1" class="data-table">
      ...
      <tr>
        ...
        <td><input type="text" size="26" maxlength="128" name="new_recipient_email" value="{$new_recipient.email|escape}" /></td>
      </tr>
