{*
$Id: event_modify.tpl,v 1.1.2.2 2011/07/16 06:59:59 aim Exp $
...
<form action="giftreg_manage.php" method="post" name="eventdetails_form">
  ...
  <table cellpadding="0" class="data-table width-100" summary="{$lng.lbl_event_info|escape}">
    ...
    <tr>
      <td class="data-name"><label for="event_details_title">{$lng.lbl_giftreg_title}</label>:</td>
      <td class="data-required">*</td>
      <td>
        <input type="text" size="50" maxlength="255" name="event_details[title]" id="event_details_title" value="{$event_data.title|escape}" />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="data-required">*</td>
      <td>
        {include file="main/datepicker.tpl" name="event_date" date=$event_data.event_date end_year="c+5"}
      </td>
    </tr>
