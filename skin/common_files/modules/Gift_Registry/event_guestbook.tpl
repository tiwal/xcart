{*
$Id: event_guestbook.tpl,v 1.1.2.1 2011/07/15 14:32:47 aim Exp $
...
<form action="{$script_name}" method="post" name="gbadd_form">
  ...
  <table cellspacing="0" class="data-table">
    ...
    <tr>
      <td class="data-name"><label for="gb_details_name">{$lng.lbl_your_name}</label>:</td>
      <td class="data-required">*</td>
      <td>
        <input type="text" size="40" name="gb_details[name]" id="gb_details_name" />
      </td>
    </tr>

    <tr>
      <td class="data-name"><label for="gb_details_subject">{$lng.lbl_subject}</label>:</td>
      <td class="data-required">*</td>
      <td>
        <input type="text" size="40" name="gb_details[subject]" id="gb_details_subject" />
      </td>
    </tr>

    <tr>
      <td class="data-name"><label for="gb_details_message">{$lng.lbl_your_message}</label>:</td>
      <td class="data-required">*</td>
      <td>
        <textarea cols="55" rows="7" name="gb_details[message]" id="gb_details_message"></textarea>
      </td>
    </tr>
