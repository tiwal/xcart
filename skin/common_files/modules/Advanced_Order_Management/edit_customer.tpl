{*
$Id: edit_customer.tpl,v 1.1.2.1 2011/12/20 09:58:44 aim Exp $
...
<tr{cycle name=c1 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="customer_info[firstname]" size="32" maxlength="128" value="{$cart_customer.firstname|escape}" /></td>
...
<tr{cycle name=c1 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="customer_info[lastname]" size="32" maxlength="128" value="{$cart_customer.lastname|escape}" /></td>
...
<tr{cycle name=c1 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="customer_info[company]" size="32" maxlength="255" value="{$cart_customer.company|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_first_name}</td>
  <td><input type="text" name="customer_info[b_firstname]" size="32" maxlength="128" value="{$cart_customer.b_firstname|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="customer_info[b_address]" size="32" maxlength="255" value="{$cart_customer.b_address|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="customer_info[b_address_2]" size="32" maxlength="128" value="{$cart_customer.b_address_2|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_first_name}</td>
  <td><input type="text" name="customer_info[s_firstname]" size="32" maxlength="128" value="{$cart_customer.s_firstname|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_address}</td>
  <td><input type="text" name="customer_info[s_address]" size="32" maxlength="255" value="{$cart_customer.s_address|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_address_2}</td>
  <td><input type="text" name="customer_info[s_address_2]" size="32" maxlength="128" value="{$cart_customer.s_address_2|escape}" /></td>
