{*
$Id: coupons.tpl,v 1.5.2.2 2011/07/16 06:59:59 aim Exp $
...
<tr>
  ...
  <td>&nbsp;</td>
  <td>
{include file="main/datepicker.tpl" name="expire_new" date=$coupon_data.expire_new end_year="c+5" start_year="c-1"}
  </td>
</tr>
