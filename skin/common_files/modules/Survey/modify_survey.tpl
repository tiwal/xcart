{*
$Id: modify_survey.tpl,v 1.3.2.1 2011/07/16 06:59:59 aim Exp $
...
<tr>
  ...
  <td>{include file="main/datepicker.tpl" name="data[valid_from_date]" id="valid_from_date" date=$survey.valid_from_date end_year="c+5" start_year="c-2"}</td>
  <td style="padding-left: 10px; padding-right: 10px;"><b>{$lng.lbl_survey_to}</b></td>
  <td>{include file="main/datepicker.tpl" name="data[expires_data]" id="expires_data" date=$survey.expires_data end_year="c+5" start_year="c-2"}</td>
</tr>
</table>
  </td>
</tr>
