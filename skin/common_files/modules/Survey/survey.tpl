{*
$Id: survey.tpl,v 1.1.2.3 2011/08/01 14:39:09 aim Exp $
...
{foreach from=$question.answers item=a key=aid}
    <div class="survey-answer">
      {include file="modules/Survey/customer_answer.tpl" surveyid=`$survey.surveyid`}
...
{assign var=aid value=$a.answerid}
        <td class="survey-answer" style="width: {$cell_width}%">
          {include file="modules/Survey/customer_answer.tpl" is_column=true surveyid=`$survey.surveyid`}
{if $a.textbox_type eq 'Y'}
          {include file="modules/Survey/customer_answer_comment.tpl"}
{/if}
        </td>
