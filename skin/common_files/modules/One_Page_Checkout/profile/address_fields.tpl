{*
$Id: address_fields.tpl,v 1.2.2.11 2012/03/22 11:43:14 aim Exp $
    ...
    <li class="{$liclass}">
      ...
      {capture name=regfield}
        ...
        {else}
          ...
          <input type="text" id="{$id_prefix}{$fname}" name="{$name_prefix}[{$fname}]" size="32" maxlength="255" value="{$address.$fname|escape}" />
