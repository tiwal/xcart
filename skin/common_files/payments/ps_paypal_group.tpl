{*
$Id: ps_paypal_group.tpl,v 1.5.2.3.2.3 2012/04/16 11:36:27 aim Exp $
          ...
          <table cellpadding="5" cellspacing="5" width="100%" id="paypal-settings">
            ...
            <tr valign="top">
              ...
              <td>
                ...
                <a href="javascript:void(0);" onclick="javascript:window.open('http://help.x-cart.com/index.php?title=X-Payments:PayPal','PPEC_HELP');">{$lng.lbl_paypal_guidelines_click}</a>
                </td>
            </tr>
            ...
            <tr valign="top">
              ...
              <td>
                ...
                <a href="javascript:void(0);" onclick="javascript:window.open();">{$lng.lbl_paypal_guidelines_click}</a>
              </td>
            </tr>
