{*
$Id: cc_paypointft.tpl,v 1.1.2.1 2011/12/23 08:32:07 aim Exp $
vim: set ts=2 sw=2 sts=2 et:
*}
<h1>PayPoint Fast Track</h1>
{$lng.txt_cc_configure_top_text}
<br /><br />
{$lng.txt_cc_ppft_note|substitute:"current_location":$https_location:"processor":$module_data.processor}
<br /><br />
{capture name=dialog}
...
<tr>
<td><label for="param07">{$lng.txt_cc_ppft_use_http_auth}:</label></td>
<td><input type="checkbox" name="param07" id="param07" value="Y" {if $module_data.param07 eq 'Y'} checked="checked"{/if}/></td>
</tr>
...
{getvar func=func_cc_paypointft_get_htaccess_code var=htaccess_code}
<div id='htaccess_note'>
{$lng.txt_cc_ppft_htaccess_note|substitute:"current_location":$https_location:"http_user":$module_data.param04:"http_pass":$module_data.param05:"payment_htaccess_path":$payment_htaccess_path:"dir_separator":$dir_separator:"htaccess_code":$htaccess_code}
</div>
<br /><br />
...
//<![CDATA[
var param07_bool = {if $module_data.param07 eq 'Y'}true{else}false{/if};

{literal}
function manage_auth_fields(show_hide)
{
  $('#param04_field').toggle(show_hide);
  $('#param05_field').toggle(show_hide);
  $('#htaccess_note').toggle(show_hide);
}


$(document).ready(function () {
    $("#param07").click(function () { 
      manage_auth_fields(this.checked)
    });

    manage_auth_fields(param07_bool)
});
{/literal}
