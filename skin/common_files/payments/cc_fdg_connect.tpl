{*
$Id: cc_fdg_connect.tpl,v 1.5.2.3 2012/02/10 05:53:52 aim Exp $
...
function change_region(region, ss_value) {ldelim}
  ...
  if (region != 'EMEA') {ldelim}
    $('#secure option[value=N]').prop('selected', true);
    $('#secure').prop('disabled', true);
  {rdelim} else {ldelim}
    $('#secure').prop('disabled', false);
  {rdelim}
