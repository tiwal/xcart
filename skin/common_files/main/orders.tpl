{*
$Id: orders.tpl,v 1.5.2.4 2011/09/14 12:36:42 aim Exp $
...
<tr>
  ...
  <td><input type="text" maxlength="32" name="posted_data[phone]" value="{$search_prefilled.phone|escape}" style="width:70%" />
