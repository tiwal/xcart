{*
$Id: commissions.tpl,v 1.4.2.4 2011/12/28 11:53:47 aim Exp $
        ...
        {foreach from=$orders item=v}
          ...
          <tr{cycle values=', class="TableSubHead"'}>
            ...
            <td align="right" nowrap="nowrap">
              {currency value=$v.commissions assign=_commission}
              {include file="main/tooltip_js.tpl" title=$_commission ajax_source="get_block.php?block=provider_commission_data&amp;orderid=`$v.orderid`&amp;userid=`$v.userid`" id="commission_`$v.orderid`" sticky=true width=350}
            </td>
