{*
$Id: orders_list.tpl,v 1.8.2.5 2011/07/01 14:20:31 aim Exp $
...
{/if}
  ...
  <td>
    ...
    {else}
      {$orders[oid].firstname|default:$orders[oid].b_firstname} {$orders[oid].lastname|default:$orders[oid].b_lastname} 
