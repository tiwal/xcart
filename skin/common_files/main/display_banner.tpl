{*
$Id: display_banner.tpl,v 1.1.2.2 2011/08/29 10:02:17 aim Exp $
...
{else}
  ...
  {if $banner.banner_type eq 'P'}
    ...
    {if $partner ne ''}
      {capture name=a_params}&amp;productid={$product.productid}&amp;bid={$banner.bannerid}&amp;partner={$partner}{/capture}
    {/if}
  ...
  {elseif $banner.banner_type eq 'C'}
    ...
    {if $partner ne ''}
      {capture name=a_params}&amp;categoryid={$categoryid}&amp;bid={$banner.bannerid}&amp;partner={$partner}{/capture}
    {/if}
  ...
  {elseif $banner.banner_type eq 'F'}
    ...
    {if $partner ne ''}
      {capture name=a_params}&amp;manufacturerid={$manufacturerid}&amp;bid={$banner.bannerid}&amp;partner={$partner}{/capture}
    {/if}
  ...
  {else}
    ...
    {if $partner ne ''}
      {capture name=a_params}&amp;bid={$banner.bannerid}&amp;partner={$partner}{/capture}
    {/if}
  {/if}
  ...
  {/if}
  {if $smarty.capture.a_params ne ''}<img src="{$catalogs.customer}/adv_counter.php?change_banner_stats_mode=Y{$smarty.capture.a_params}" alt="" width="0" height="0" style="display: none;" />{/if}
