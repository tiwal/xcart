{*
$Id: address_fields.tpl,v 1.6.2.2 2011/12/20 09:58:44 aim Exp $
...
<tr class="address-row-{$id}"{if $hide} style="display:none;"{/if}>
  ...
  {if $address_fields.firstname.avail eq 'Y'}
    <tr>
      ...
      <td>
        <input type="text" id="firstname{$id}" name="address_book[{$id}][firstname]" size="32" maxlength="128" value="{$address.firstname|escape}" />
      </td>
    </tr>
  {/if}
  ...
  {if $address_fields.address.avail eq 'Y'}
    <tr>
      ...
      <td>
        <input type="text" id="address{$id}" name="address_book[{$id}][address]" size="32" maxlength="255" value="{$address.address|escape}" />
      </td>
    </tr>
  {/if}
  ...
  {if $address_fields.address_2.avail eq 'Y'}
    <tr>
      ...
      <td>
        <input type="text" id="address_2{$id}" name="address_book[{$id}][address_2]" size="32" maxlength="128" value="{$address.address_2|escape}" />
      </td>
    </tr>
  {/if}
