{*
$Id: register_provider.tpl,v 1.1.2.1 2011/12/20 09:58:45 aim Exp $
...
<td nowrap="nowrap">
<input type="text" id="address_2" name="address_2" size="32" maxlength="255" value="{$userinfo.seller_address_2|escape}" />
...
<td nowrap="nowrap">
<input type="text" id="city" name="city" size="32" maxlength="255" value="{$userinfo.seller_city|escape}" />
