{*
$Id: tools.tpl,v 1.6.2.7.2.1 2012/04/06 13:01:30 aim Exp $
...
<tr>
  <td colspan="2">
    ...
    <br />
    <br />
    {include file="main/tooltip_js.tpl" title=$lng.lbl_function_for_upgraded text=$lng.txt_function_for_upgraded}
    <br />
...
{$k}: {$v}{if $row.url} <a href="{$row.url}{$v}">{$lng.lbl_click_here_to_check}</a>{/if}<br />
{/foreach}
    </td>
    <td valign="top">
