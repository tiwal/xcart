{*
$Id: users.tpl,v 1.6.2.3 2011/12/20 09:58:43 aim Exp $
...
<tr>
  ...
  <input type="text" maxlength="128" name="posted_data[city]" value="{$search_prefilled.city|escape}" style="width:70%" />
  </td>
</tr>
...
<tr>
  ...
  <td height="10" width="80%">
  <input type="text" maxlength="32" name="posted_data[phone]" value="{$search_prefilled.phone|escape}" style="width:70%" />
  </td>
</tr>
...
<tr>
  ...
  <td height="10" width="80%">
  <input type="text" maxlength="255" name="posted_data[url]" value="{$search_prefilled.url|escape}" style="width:70%" />
  </td>
</tr>
