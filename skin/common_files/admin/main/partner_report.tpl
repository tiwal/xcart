{*
$Id: partner_report.tpl,v 1.1.2.2 2011/08/30 06:13:40 aim Exp $
...
<tr{cycle values=", class='TableSubHead'"}>
  <td>{$v.firstname} {$v.lastname} <a href="{$catalogs.admin}/user_modify.php?user={$v.id}&amp;usertype=B">({$v.login})</a></td>
