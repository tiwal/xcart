{*
$Id: test_shippings.tpl,v 1.3.2.1 2011/12/20 09:58:43 aim Exp $
...
<tr valign="middle">
  ...
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="origin[address]" size="32" maxlength="255" value="{$orig_address.address}" /></td>
</tr>

<tr valign="middle">
  <td align="right" width="25%">{$lng.lbl_city}:</td>
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%"><input type="text" name="origin[city]" size="32" maxlength="128" value="{$orig_address.city}" /></td>
</tr>
...
<tr valign="middle">
  ...
  <input type="text" name="s_address" size="32" maxlength="255" value="{$userinfo.s_address|escape}" />
  </td>
</tr>
...
<tr valign="middle">
  ...
  <td>&nbsp;</td>
  <td nowrap="nowrap" width="75%">
  <input type="text" name="s_city" size="32" maxlength="255" value="{$userinfo.s_city|escape}" />
  </td>
</tr>
