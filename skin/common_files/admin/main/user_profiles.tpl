{*
$Id: user_profiles.tpl,v 1.3.2.3 2011/12/20 09:58:43 aim Exp $
...
<tr>
  ...
  <td><input type="text" size="30" maxlength="255" name="update[{$v.fieldid}][field]" value="{$v.title|default:$v.field}" /></td>
  <td>
...
<tr>
  <td>&nbsp;</td>
  <td><input type="text" name="newfield" size="30" maxlength="255" /></td>
  <td>
