{*
$Id: category_modify.tpl,v 1.6.2.1 2012/03/27 06:17:19 aim Exp $
...
{if $c.moving_enabled}
  <option value="{$catid}"{if $catid eq $current_category.parentid} selected="selected" disabled="disabled"{/if}>{$c.category_path}</option>
{/if}
{/foreach}
</select>
  </td>
