{*
$Id: general.tpl,v 1.2.2.2 2012/02/22 12:29:11 aim Exp $
...
<td>{if $payment_methods[idx].processor ne ''}<a href="cc_processing.php?mode=update&amp;cc_processor={$payment_methods[idx].processor}">{$payment_methods[idx].payment_method}</a>{else}{$payment_methods[idx].payment_method}{/if}</td>
