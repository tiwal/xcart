{*
$Id: contactus.tpl,v 1.3.2.2 2011/12/20 09:58:44 aim Exp $
...
<td nowrap="nowrap">
<input type="text" id="username" name="username" size="32" maxlength="128" value="{if $userinfo.username ne ''}{$userinfo.username|escape}{else}{$userinfo.login|escape}{/if}" />
</td>
</tr>
{/if}
...
<td nowrap="nowrap">
<input type="text" id="b_address" name="b_address" size="32" maxlength="255" value="{$userinfo.b_address|escape}" />
</td>
</tr>
{/if}
...
<td nowrap="nowrap">
<input type="text" id="b_address_2" name="b_address_2" size="32" maxlength="128" value="{$userinfo.b_address_2|escape}" />
</td>
</tr>
{/if}
...
<td nowrap="nowrap">
<input type="text" id="fax" name="fax" size="32" maxlength="32" value="{$userinfo.fax|escape}" /></td>
</tr>
{/if}
