{*
$Id: register_account.tpl,v 1.3.2.1 2011/11/28 06:52:07 ferz Exp $
...
{/if}
  ...
  {if $allow_pwd_modify eq 'Y'}
    ...
    <tr>
      ...
      <td class="data-required">*</td>
      <td>
        <input type="password" id="passwd1" name="passwd1" class="input-required" size="32" maxlength="64" value="{$userinfo.passwd1|escape}" autocomplete="off" />
    ...
    <tr>
      ...
      <td class="data-required">*</td>
      <td>
        <input type="password" id="passwd2" name="passwd2" class="input-required" size="32" maxlength="64" value="{$userinfo.passwd2|escape}" autocomplete="off" />
