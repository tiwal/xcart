{*
$Id: contactus.tpl,v 1.3.2.3 2011/12/20 09:58:44 aim Exp $
      ...
      <table cellspacing="0" class="data-table" summary="{$lng.lbl_contact_us|escape}">
        ...
        {if $default_fields.b_address_2.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="b_address_2" name="b_address_2" size="32" maxlength="255" value="{$userinfo.b_address_2|escape}" />
            </td>
          </tr>
        {/if}
