...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
				...
				w = (zoomImage.width < w) ? zoomImage.width : w;
				h = (zoomImage.height < h) ? zoomImage.height : h;
				...
				cw = (zoomImage.width < cw) ? zoomImage.width : cw;
				ch = (zoomImage.height < ch) ? zoomImage.height : ch;
        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
                ...
                $(this).bind('click', $(this), function (event) {
					...
					$('#' + data.useZoom + ' img').css({'width' : 'auto', 'height': 'auto'});
					$('.cloud-zoom').width($('#' + data.useZoom + ' img').width());
					$('.cloud-zoom').height($('#' + data.useZoom + ' img').height());
