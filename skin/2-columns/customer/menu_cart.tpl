{*
$Id: menu_cart.tpl,v 1.3.2.1 2012/02/20 09:04:21 aim Exp $
...
{if $minicart_total_items gt 0}
  {assign var=additional_class value=$additional_class|cat:" full"}
{else}
  {assign var=additional_class value=$additional_class|cat:" empty"}
{/if}
{include file="customer/minicart_total.tpl" assign="title"}
{include file="customer/menu_dialog.tpl" content=$smarty.capture.menu}
