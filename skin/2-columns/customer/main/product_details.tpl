{*
$Id: product_details.tpl,v 1.7.2.6 2012/02/28 13:55:51 aim Exp $
...
<form name="orderform" method="post" action="cart.php" onsubmit="javascript: return FormValidation(this);" id="orderform">
  ...
  <table cellspacing="0" class="product-properties" summary="{$lng.lbl_description|escape}">
    ...
    <tr{if $product.appearance.has_market_price and $product.appearance.market_price_discount gt 0} class="product-price-row"{/if}>
