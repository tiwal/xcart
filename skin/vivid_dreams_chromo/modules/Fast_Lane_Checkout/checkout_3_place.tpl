{*
$Id: checkout_3_place.tpl,v 1.4.2.5 2012/01/20 10:26:13 aim Exp $
...
{/capture}
{include file="customer/dialog.tpl" title=$lng.lbl_place_order content=$smarty.capture.dialog additional_class="cart big_title"}
