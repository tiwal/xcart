 ...
 * @version    $Id: offers.php,v 1.23.2.4 2012/03/27 11:18:44 aim Exp $
 * @link       http://www.x-cart.com/
 * @see        ____file_see____
 */

define('USE_TRUSTED_POST_VARIABLES', true);
$trusted_post_variables = array('offer_lng');
...
include $xcart_dir . '/modules/Special_Offers/offers.php';

$smarty->assign('main','special_offers');
