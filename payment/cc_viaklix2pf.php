 ...
 * @version    $Id: cc_viaklix2pf.php,v 1.18.2.4.2.1 2012/04/18 08:40:24 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == "GET" && (isset($_GET['errorCode']) || isset($_GET['ssl_result']))) {
    ...
    $bill_output['sessid'] = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref='" . $ssl_invoice_number . "'");
    ...
    if (!$duplicate)
        db_query("REPLACE INTO $sql_tbl[cc_pp3_data] (ref,sessid) VALUES ('".addslashes($ssl_invoice_number)."','".$XCARTSESSID."')");
