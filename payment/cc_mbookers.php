 ...
 * @version    $Id: cc_mbookers.php,v 1.44.2.4.2.1 2012/04/18 08:40:23 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == "GET" && !empty($_GET["status"]) && !empty($_GET["oid"])) {
    ...
    $sessid = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] where ref='" . $transaction_id . "'");
