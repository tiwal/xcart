 ...
 * @version    $Id: cc_pnpss.php,v 1.36.2.5.2.1 2012/04/18 08:40:24 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET["FinalStatus"]) && isset($_GET["orderID"])) {
    ...
    $bill_output['sessid'] = func_query_first_cell("select sessid from $sql_tbl[cc_pp3_data] where ref='".$_GET["orderID"]."'");
    ...
    $post = array(
        ...
        'success-link' => $current_location . '/payment/cc_pnpss.php',
        'badcard-link' => $current_location . '/payment/cc_pnpss.php',
        'problem-link' => $current_location . '/payment/cc_pnpss.php'
    );
