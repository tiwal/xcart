 ...
 * @version    $Id: cc_isecure.php,v 1.48.2.4.2.1 2012/04/18 08:40:23 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET["ok"]) && isset($_GET["ordr"])) {
    ...
    $bill_output['sessid'] = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref='".$ordr."'");
