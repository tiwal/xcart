...
/**
 * "PayFlow Link" payment module (credit card processor)
 *
 * @category   X-Cart
 * @package    X-Cart
 ...
 * @version    $Id: cc_payflow_link_result.php,v 1.15.2.6.2.1 2012/04/18 08:40:24 aim Exp $
...
$a = func_query_first("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref = '".$INVOICE."'");
if (empty($a))
    exit;
