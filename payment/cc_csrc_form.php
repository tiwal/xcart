 ...
 * @version    $Id: cc_csrc_form.php,v 1.14.2.4.2.1 2012/04/18 08:40:23 aim Exp $
...
if ($REQUEST_METHOD == 'POST' && !empty($_POST['signedFields'])) {
    ...
    $bill_output['sessid'] = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref = '".$orderNumber."'");
