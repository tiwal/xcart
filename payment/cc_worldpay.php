...
/**
 * WorldPay - HTML Redirect - Select Junior / RBS WorldPay - Business Gateway
 *
 * @category   X-Cart
 * @package    X-Cart
 ...
 * @version    $Id: cc_worldpay.php,v 1.66.2.5.2.1 2012/04/18 08:40:24 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && !empty($_POST["cartId"]) && !empty($_POST["transStatus"])) {
    ...
    $bill_output['sessid'] = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref='".$cartId."'");
    ...
    $url = ($module_params['testmode'] == 'N') ? 'https://secure.worldpay.com/wcc/purchase' : "https://secure-test.worldpay.com/wcc/purchase";
