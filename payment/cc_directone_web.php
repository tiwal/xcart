 ...
 * @version    $Id: cc_directone_web.php,v 1.14.2.6.2.1 2012/04/18 08:40:23 aim Exp $
...
if ($REQUEST_METHOD == 'GET' && isset($_GET['result'])) {
    ...
    $pp3_data = func_query_first("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref='".$_GET['oid']."'");
    ...
    $return_url = $current_location."/payment/cc_directone_web.php?oid=$ordr&";
