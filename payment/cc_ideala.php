 ...
 * @version    $Id: cc_ideala.php,v 1.19.2.4.2.1 2012/04/18 08:40:23 aim Exp $
...
if (isset($_GET) && isset($_GET['ec']) && $_GET['ec'] && isset($_GET['trxid']) && $_GET['trxid']) {
    ...
    $module_params = func_query_first("SELECT * FROM $sql_tbl[ccprocessors] WHERE processor = 'cc_ideala.php'");
