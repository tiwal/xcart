 ...
 * @version    $Id: cc_authorizenet_sim.php,v 1.53.2.6.2.1 2012/04/18 08:40:23 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['x_response_code']) {
    ...
    $bill_output['sessid'] = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref='".$_POST["x_invoice_num"]."'");
