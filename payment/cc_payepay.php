...
/**
 * "PayEpay" payment module (credit card processor)
 *
 * @category   X-Cart
 * @package    X-Cart
 ...
 * @version    $Id: cc_payepay.php,v 1.38.2.6.2.1 2012/04/18 08:40:24 aim Exp $
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && !empty($_POST["option1"]) && !empty($_POST["cc_status"])) {
    ...
    $bill_output['sessid'] = func_query_first_cell("SELECT sessid FROM $sql_tbl[cc_pp3_data] WHERE ref='".$option1."'");
    ...
    $returnurl = $current_location.'/payment/cc_payepay.php';
