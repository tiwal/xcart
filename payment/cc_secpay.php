 ...
 * @version    $Id: cc_secpay.php,v 1.41.2.6.2.1 2012/04/18 08:40:24 aim Exp $
...
if (!defined('XCART_START') && ((isset($_POST["is_callback"]) && $_POST["is_callback"] == "Y") || (isset($_GET["is_callback"]) && $_GET["is_callback"] == "Y"))) {
    ...
    $tmp = func_query_first("SELECT sessid,param1 FROM $sql_tbl[cc_pp3_data] WHERE ref='".$trans_id."'");
...
// Request
    ...
    if(!$duplicate) {
        db_query("REPLACE INTO $sql_tbl[cc_pp3_data] (ref,sessid, param1) VALUES ('".addslashes($_orderids)."','".$XCARTSESSID."', '$md5_orig')");
    }
