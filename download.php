 ...
 * @version    $Id: download.php,v 1.45.2.8.2.1 2012/04/06 13:01:28 aim Exp $
...
if (
    ...
    $result = func_query_first("SELECT p.distribution, pl.product, p.provider FROM $sql_tbl[products] AS p INNER JOIN $sql_tbl[products_lng_current] AS pl USING(productid) WHERE p.productid = '$productid'");
